...
Como vemos, solo una columna sigue una distribución normal, por lo que no podemos aplicar este método a este conjunto de datos. Aun así se explicará como se haría si tuvieramos varias columnas con una distribución normal.
...
# solo tenemos una columna que sigue una normal, no podemos aplicar mvn, en caso de tener varias columnas descomentar estas tres intrucciones
...
*AVISO*: Al solo obtener tener columna que sigue una distribución normal el código está comentado ya que no es aplicable en este caso, aun así he descrito como se realizaría y la interpretación de los resultados. 
